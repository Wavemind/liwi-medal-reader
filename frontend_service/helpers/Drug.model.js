 ...
 * @returns {string}
 */
export const formulationLabel = (calculatedFormulation, algorithmLanguage) => {
  switch (calculatedFormulation.medication_form) {
    ...
    case medicationForms.inhaler: {
      return `${translateText(calculatedFormulation.description, algorithmLanguage)}: ${roundSup(calculatedFormulation.unique_dose)} ${i18n.t(`medication_form:${calculatedFormulation.medication_form}`).toLowerCase()}`;
    }
    case medicationForms.tablet:
    case medicationForms.capsule: {
      if (calculatedFormulation.by_age) {
        return `${translateText(calculatedFormulation.description, algorithmLanguage)}: ${roundSup(calculatedFormulation.unique_dose)} ${i18n.t('drug:tablets')}`;
      }
    ...
    case medicationForms.drops: {
      return `${translateText(calculatedFormulation.description, algorithmLanguage)}`;
    }
    case medicationForms.syrup:
    case medicationForms.suspension:
    case medicationForms.powder_for_injection:
    case medicationForms.solution: {
      if (calculatedFormulation.by_age) {
        return `${translateText(calculatedFormulation.description, algorithmLanguage)}: ${roundSup(calculatedFormulation.unique_dose)}ml`;
      }
    ...
    default: {
      return `(${calculatedFormulation.medication_form}) ${i18n.t('drug:medication_form_not_handled')}`;
    }
  }
};
