              ...
              <Button
                  ...
                  onPress={async () => {
                    ...
                    console.log({
                      ...
                      size_nodes: memorySizeOf(algorithm.nodes),
                      size_emergency_content: memorySizeOf(algorithm.emergency_content),
                      size_study: memorySizeOf(algorithm.study),
                      size_diagnostics: memorySizeOf(algorithm.diagnostics),
