...
export { default as CustomDrug } from './Diagnoses/Summary/CustomDrug'
export { default as Drugs } from './Diagnoses/Summary/Drugs'
export { default as Managements } from './Diagnoses/Summary/Managements'
export { default as Management } from './Diagnoses/Summary/Management'
export { default as DoseIndication } from './Diagnoses/Summary/DoseIndication'
